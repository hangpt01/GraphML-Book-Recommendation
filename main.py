...
def parse_arguments():
    ...
    parser.add_argument('--gpu_id', type=int, default=0,
                        help='GPU')
    parser.add_argument('--dataset', type=str, default='lastfm', choices=['mind-f', 'lastfm', 'alibaba-fashion', 'ml-1m', 'library'],
                        help='Dataset name')
    ...
    parser.add_argument('--lrate', type=float, default=0.005,
                        help='Lrate')
    parser.add_argument('--item_ranking', type=str, default='5,10,20')
...
if __name__ == '__main__':
    ...
    graph_baselines = ['LightGCN', 'KGAT', 'HGCN', 'KHGRec', 'DHCF', 'GCCF']
